    ...
    while y == list([u*3 for u in x]):
        ...
        for i, a in enumerate(x):
            if i in changes:
                ...
                out1.append(a)
        x = out1
    return f'maptimesthree({out1},{y})'

MAPTIMESTHREE = 'maptimesthree'

class MapTimesThree(ListProblem):
    def __init__(self):
        super().__init__(MAPTIMESTHREE, gen_pos, gen_neg, MAPTIMESTHREE, num_examples=[60, 60, 1000, 1000])
