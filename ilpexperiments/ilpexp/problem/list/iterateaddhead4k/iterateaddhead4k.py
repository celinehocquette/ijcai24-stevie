...
def gen_pos():
    ...
    output = input[:]
    output[0] += 4*n
    return f'iterateaddhead4k({n},{input},{output})'
...
def gen_neg():
    ...
    return f'iterateaddhead4k({n},{input},{output2})'


ITERATEADDHEAD4K = 'iterateaddhead4k'


class IterateAddHead4K(ListProblem):
    def __init__(self):
        super().__init__(ITERATEADDHEAD4K, gen_pos, gen_neg, ITERATEADDHEAD4K)
