...
from stevie.loreleai.learning.restructuring import Restructor, NUM_LITERALS

ROOT_FOLDER = os.path.abspath(os.path.dirname(__file__))
TRIAL = [1]
NUMBER_PLAY_TASKS = list(range(200, 2200, 200))
THREADS = 4
MAX_TIME_S = 1 * 2 * 60    # hour * ifthenelse_min * sec
MAX_LAYERS = None
MIN_LITERALS = 2
MAX_LITERALS = 2
PRUNE = True
