...
ho_126(A,B,P,Q)  :- head(A,C),tail(A,D),call(P,C),ho_126(D,B,P,Q).

ho_126(A,B,P,Q)  :- head(A,C),tail(A,D),call(Q,C),ho_126(D,E,P,Q),my_increment(E,B).

ho_1(A,B,P)  :- call(P,A,C),call(P,C,D),call(P,D,E),call(P,E,F),call(P,F,B).

ho_181(A,B,P)  :- empty(A),empty(B).

ho_181(A,B,P)  :- head(A,C),tail(A,D),head(B,E),tail(B,F),call(P,C,E),ho_181(D,F,P).
...
ho_12(A,B,C,P)  :- decrement(A,D),call(P,B,E),ho_12(D,E,C,P).

ho_492(A,B,P,Q)  :- empty(A),empty(B).

ho_492(A,B,P,Q)  :- cons3(A,C,D),call(P,C),ho_492(D,B,P,Q).

ho_492(A,B,P,Q)  :- cons3(A,C,D),call(Q,C),ho_492(D,E,P,Q),cons(C,E,B).
