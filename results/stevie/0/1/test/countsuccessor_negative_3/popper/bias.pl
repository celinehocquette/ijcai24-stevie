...
body_pred(ho_1,3,ho).
body_pred(ho_12,4,ho).
body_pred(ho_181,3,ho).
body_pred(ho_492,4,ho).
body_pred(ho_2,2,ho).
body_pred(ho_126,4,ho).
body_pred(ho_101,4,ho).
type(ho_1,(list, list, (list, list))).
type(ho_2,(list, (element, ))).
type(ho_12,(element, list, list, (list, list))).
type(ho_101,(list, element, (element, ), (element, element, element))).
type(ho_126,(list, int, (element, ), (element, ))).
type(ho_181,(list, list, (element, element))).
type(ho_492,(list, list, (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_2,(in, (in, ))).
direction(ho_12,(in, in, out, (in, out))).
direction(ho_101,(in, out, (in, ), (in, in, out))).
direction(ho_126,(in, out, (in, ), (in, ))).
direction(ho_181,(in, in, (in, out))).
direction(ho_492,(in, out, (in, ), (in, ))).
