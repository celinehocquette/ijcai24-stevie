...
body_pred(ho_7,2,ho).
body_pred(ho_148,4,ho).
body_pred(ho_1,3,ho).
body_pred(ho_44,2,ho).
body_pred(ho_105,4,ho).
body_pred(ho_308,2,ho).
body_pred(ho_15,4,ho).
body_pred(ho_491,4,ho).
body_pred(ho_252,4,ho).
type(ho_1,(list, list, (list, list))).
type(ho_7,(list, (element, ))).
type(ho_15,(element, list, list, (list, list))).
type(ho_44,(list, (element, ))).
type(ho_105,(list, element, (element, ), (element, element, element))).
type(ho_148,(list, int, (element, ), (element, ))).
type(ho_185,(list, list, (element, element))).
type(ho_252,(list, list, (list, list), (element, ))).
type(ho_308,(list, (element, element))).
type(ho_491,(list, list, (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_7,(in, (in, ))).
direction(ho_15,(in, in, out, (in, out))).
direction(ho_44,(in, (in, ))).
direction(ho_105,(in, out, (in, ), (in, in, out))).
direction(ho_148,(in, out, (in, ), (in, ))).
direction(ho_185,(in, in, (in, out))).
direction(ho_252,(in, out, (in, out), (in, ))).
direction(ho_308,(in, (in, in))).
direction(ho_491,(in, out, (in, ), (in, ))).
