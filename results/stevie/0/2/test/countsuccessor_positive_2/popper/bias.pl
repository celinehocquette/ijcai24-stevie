...
body_pred(ho_41,2,ho).
body_pred(ho_103,4,ho).
body_pred(ho_1,3,ho).
body_pred(ho_487,4,ho).
body_pred(ho_182,3,ho).
body_pred(ho_134,4,ho).
body_pred(ho_2,2,ho).
body_pred(ho_15,4,ho).
type(ho_1,(list, list, (list, list))).
type(ho_2,(list, (element, ))).
type(ho_15,(element, list, list, (list, list))).
type(ho_41,(list, (element, ))).
type(ho_103,(list, element, (element, ), (element, element, element))).
type(ho_134,(list, int, (element, ), (element, ))).
type(ho_182,(list, list, (element, element))).
type(ho_487,(list, list, (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_2,(in, (in, ))).
direction(ho_15,(in, in, out, (in, out))).
direction(ho_41,(in, (in, ))).
direction(ho_103,(in, out, (in, ), (in, in, out))).
direction(ho_134,(in, out, (in, ), (in, ))).
direction(ho_182,(in, in, (in, out))).
direction(ho_487,(in, out, (in, ), (in, ))).
