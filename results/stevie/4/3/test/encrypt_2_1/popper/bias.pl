...
body_pred(ho_499,4,ho).
body_pred(ho_10,2,ho).
body_pred(ho_272,4,ho).
body_pred(ho_319,2,ho).
body_pred(ho_5,4,ho).
body_pred(ho_116,4,ho).
body_pred(ho_383,4,ho).
body_pred(ho_1,3,ho).
body_pred(ho_290,2,ho).
body_pred(ho_251,3,ho).
body_pred(ho_145,4,ho).
type(ho_1,(list, list, (list, list))).
type(ho_5,(list, list, (list, list), (element, ))).
type(ho_10,(list, (element, element))).
type(ho_116,(list, element, (element, ), (element, element, element))).
type(ho_145,(list, int, (element, ), (element, ))).
type(ho_251,(list, list, (element, element))).
type(ho_272,(list, list, (element, ), (element, ))).
type(ho_290,(list, (element, ))).
type(ho_319,(list, (element, ))).
type(ho_383,(list, element, (element, ), (element, element, element))).
type(ho_499,(element, list, list, (list, list))).
direction(ho_1,(in, out, (in, out))).
direction(ho_5,(in, out, (in, out), (in, ))).
direction(ho_10,(in, (in, in))).
direction(ho_116,(in, out, (out, ), (in, in, out))).
direction(ho_145,(in, out, (in, ), (in, ))).
direction(ho_251,(in, in, (in, out))).
direction(ho_272,(in, out, (in, ), (in, ))).
direction(ho_290,(in, (in, ))).
direction(ho_319,(in, (in, ))).
direction(ho_383,(in, out, (in, ), (in, in, out))).
direction(ho_499,(in, in, out, (in, out))).
