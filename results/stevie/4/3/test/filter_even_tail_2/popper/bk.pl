...
ho_272(A,B,P,Q)  :- cons3(A,C,D),call(P,C),ho_272(D,B,P,Q).

ho_272(A,B,P,Q)  :- cons3(A,C,D),call(Q,C),ho_272(D,E,P,Q),cons(C,E,B).

ho_10(A,P)  :- tail(A,B),empty(B).

ho_10(A,P)  :- head(A,B),tail(A,C),ho_10(C,P),head(C,D),call(P,B,D).
...
ho_116(A,B,P,Q)  :- empty(A),call(P,B).

ho_116(A,B,P,Q)  :- head(A,C),tail(A,D),ho_116(D,E,P,Q),call(Q,C,E,B).

ho_5(A,B,P,Q)  :- call(P,A,B),head(B,C),call(Q,C).

ho_5(A,B,P,Q)  :- call(P,A,C),ho_5(C,B,P,Q).

ho_383(A,B,P,Q)  :- empty(A),call(P,B).

ho_383(A,B,P,Q)  :- head(A,C),tail(A,D),ho_383(D,E,P,Q),call(Q,E,C,B).
