...
addlast5(A,B):- addlast1(A,C),addlast1(C,F),addlast1(F,E),addlast1(E,D),addlast1(D,B).
repeatminushead5(A,B):- minushead1(A,E),minushead1(E,F),minushead1(F,D),minushead1(D,C),minushead1(C,B).
