...
body_pred(ho_155,4,ho).
body_pred(ho_273,4,ho).
body_pred(ho_378,4,ho).
body_pred(ho_251,3,ho).
body_pred(ho_288,2,ho).
body_pred(ho_12,2,ho).
body_pred(ho_317,2,ho).
type(ho_5,(list, list, (list, list), (element, ))).
type(ho_12,(list, (element, element))).
type(ho_109,(list, element, (element, ), (element, element, element))).
type(ho_155,(list, int, (element, ), (element, ))).
type(ho_251,(list, list, (element, element))).
type(ho_273,(list, list, (element, ), (element, ))).
type(ho_288,(list, (element, ))).
type(ho_317,(list, (element, ))).
...
direction(ho_12,(in, (in, in))).
direction(ho_109,(in, out, (out, ), (in, in, out))).
direction(ho_155,(in, out, (in, ), (in, ))).
direction(ho_251,(in, in, (in, out))).
direction(ho_273,(in, out, (in, ), (in, ))).
direction(ho_288,(in, (in, ))).
direction(ho_317,(in, (in, ))).
