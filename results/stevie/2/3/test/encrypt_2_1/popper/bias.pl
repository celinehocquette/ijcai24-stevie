...
body_pred(ho_43,4,ho).
body_pred(ho_142,3,ho).
body_pred(ho_23,2,ho).
body_pred(ho_19,4,ho).
body_pred(ho_288,4,ho).
body_pred(ho_194,2,ho).
body_pred(ho_1,3,ho).
body_pred(ho_2,4,ho).
body_pred(ho_62,2,ho).
body_pred(ho_175,4,ho).
type(ho_1,(list, list, (list, list))).
type(ho_2,(element, list, list, (list, list))).
type(ho_19,(list, list, (list, list), (element, ))).
type(ho_23,(list, (element, ))).
type(ho_43,(list, element, (element, ), (element, element, element))).
type(ho_62,(list, (element, element))).
type(ho_142,(list, list, (element, element))).
type(ho_175,(list, list, (element, ), (element, ))).
type(ho_194,(list, (element, ))).
type(ho_288,(list, int, (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_2,(in, in, out, (in, out))).
direction(ho_19,(in, out, (in, out), (in, ))).
direction(ho_23,(in, (in, ))).
direction(ho_43,(in, out, (in, ), (in, in, out))).
direction(ho_62,(in, (in, in))).
direction(ho_142,(in, in, (in, out))).
direction(ho_175,(in, out, (in, ), (in, ))).
direction(ho_194,(in, (in, ))).
direction(ho_288,(in, out, (in, ), (in, ))).
