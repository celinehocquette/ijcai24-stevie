...
body_pred(ho_279,4,ho).
body_pred(ho_144,3,ho).
body_pred(ho_24,2,ho).
body_pred(ho_19,4,ho).
body_pred(ho_51,4,ho).
body_pred(ho_62,2,ho).
type(ho_19,(list, list, (list, list), (element, ))).
type(ho_24,(list, (element, ))).
type(ho_51,(list, element, (element, ), (element, element, element))).
type(ho_62,(list, (element, element))).
type(ho_144,(list, list, (element, element))).
type(ho_279,(list, int, (element, ), (element, ))).
direction(ho_19,(in, out, (in, out), (in, ))).
direction(ho_24,(in, (in, ))).
direction(ho_51,(in, out, (in, ), (in, in, out))).
direction(ho_62,(in, (in, in))).
direction(ho_144,(in, in, (in, out))).
direction(ho_279,(in, out, (in, ), (in, ))).
