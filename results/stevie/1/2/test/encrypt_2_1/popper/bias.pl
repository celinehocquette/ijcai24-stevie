...
body_pred(ho_96,4,ho).
body_pred(ho_44,4,ho).
body_pred(ho_5,4,ho).
body_pred(ho_323,4,ho).
body_pred(ho_186,2,ho).
body_pred(ho_1,3,ho).
body_pred(ho_63,3,ho).
...
type(ho_63,(list, list, (element, element))).
type(ho_96,(list, list, (element, ), (element, ))).
type(ho_153,(list, (element, ))).
type(ho_186,(list, (element, element))).
type(ho_232,(element, list, list, (list, list))).
type(ho_323,(list, int, (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_5,(in, out, (in, out), (in, ))).
direction(ho_44,(in, out, (out, ), (in, in, out))).
direction(ho_63,(in, in, (in, out))).
direction(ho_96,(in, out, (in, ), (in, ))).
direction(ho_153,(in, (in, ))).
direction(ho_186,(in, (in, in))).
direction(ho_232,(in, in, out, (in, out))).
direction(ho_323,(in, out, (in, ), (in, ))).
