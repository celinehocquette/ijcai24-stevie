...
ho_63(A,B,P)  :- head(A,C),tail(A,D),head(B,E),tail(B,F),call(P,C,E),ho_63(D,F,P).
...
ho_232(A,B,C,P)  :- decrement(A,D),ho_232(D,B,E,P),call(P,E,C).
...
ho_323(A,B,P,Q)  :- head(A,C),tail(A,D),call(P,C),ho_323(D,B,P,Q).

ho_323(A,B,P,Q)  :- head(A,C),tail(A,D),call(Q,C),ho_323(D,E,P,Q),my_increment(E,B).
...
ho_96(A,B,P,Q)  :- cons3(A,C,D),call(P,C),ho_96(D,B,P,Q).

ho_96(A,B,P,Q)  :- cons3(A,C,D),call(Q,C),ho_96(D,E,P,Q),cons(C,E,B).
