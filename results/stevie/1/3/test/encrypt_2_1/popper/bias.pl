...
body_pred(ho_16,2,ho).
body_pred(ho_23,4,ho).
body_pred(ho_7,4,ho).
body_pred(ho_511,4,ho).
body_pred(ho_155,2,ho).
body_pred(ho_45,4,ho).
body_pred(ho_234,4,ho).
body_pred(ho_322,4,ho).
body_pred(ho_186,2,ho).
body_pred(ho_62,3,ho).
body_pred(ho_1,3,ho).
body_pred(ho_100,4,ho).
type(ho_1,(list, list, (list, list))).
type(ho_7,(list, list, (list, list), (element, ))).
type(ho_16,(list, (element, ))).
type(ho_23,(element, list, list, (list, list))).
type(ho_45,(list, element, (element, ), (element, element, element))).
type(ho_62,(list, list, (element, element))).
type(ho_100,(list, list, (element, ), (element, ))).
type(ho_155,(list, (element, ))).
type(ho_186,(list, (element, element))).
type(ho_234,(element, list, list, (list, list))).
type(ho_322,(list, int, (element, ), (element, ))).
type(ho_511,(list, element, (element, ), (element, element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_7,(in, out, (in, out), (in, ))).
direction(ho_16,(in, (in, ))).
direction(ho_23,(in, in, out, (in, out))).
direction(ho_45,(in, out, (out, ), (in, in, out))).
direction(ho_62,(in, in, (in, out))).
direction(ho_100,(in, out, (in, ), (in, ))).
direction(ho_155,(in, (in, ))).
direction(ho_186,(in, (in, in))).
direction(ho_234,(in, in, out, (in, out))).
direction(ho_322,(in, out, (in, ), (in, ))).
