...
type(ho_5,(state, state, (state, state), (element, ))).
type(ho_14,(state, (element, ))).
type(ho_24,(element, state, state, (state, state))).
type(ho_44,(state, element, (element, ), (element, element, element))).
type(ho_61,(state, state, (element, element))).
type(ho_102,(state, state, (element, ), (element, ))).
type(ho_153,(state, (element, ))).
type(ho_186,(state, (element, element))).
type(ho_234,(element, state, state, (state, state))).
type(ho_316,(state, element, (element, ), (element, ))).
type(ho_511,(state, element, (element, ), (element, element, element))).
