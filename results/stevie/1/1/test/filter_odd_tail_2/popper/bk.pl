...
ho_94(A,B,P,Q)  :- cons3(A,C,D),call(P,C),ho_94(D,B,P,Q).

ho_94(A,B,P,Q)  :- cons3(A,C,D),call(Q,C),ho_94(D,E,P,Q),cons(C,E,B).

ho_320(A,B,P,Q)  :- empty(A),zero_int(B).

ho_320(A,B,P,Q)  :- head(A,C),tail(A,D),call(P,C),ho_320(D,B,P,Q).

ho_320(A,B,P,Q)  :- head(A,C),tail(A,D),call(Q,C),ho_320(D,E,P,Q),my_increment(E,B).
...
ho_188(A,P)  :- head(A,B),tail(A,C),ho_188(C,P),head(C,D),call(P,B,D).
...
ho_60(A,B,P)  :- head(A,C),tail(A,D),head(B,E),tail(B,F),call(P,C,E),ho_60(D,F,P).
