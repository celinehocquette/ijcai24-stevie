...
body_pred(ho_320,4,ho).
body_pred(ho_7,4,ho).
body_pred(ho_155,2,ho).
body_pred(ho_1,3,ho).
body_pred(ho_94,4,ho).
body_pred(ho_60,3,ho).
body_pred(ho_188,2,ho).
type(ho_1,(list, list, (list, list))).
type(ho_7,(list, list, (list, list), (element, ))).
type(ho_60,(list, list, (element, element))).
type(ho_94,(list, list, (element, ), (element, ))).
type(ho_155,(list, (element, ))).
type(ho_188,(list, (element, element))).
type(ho_320,(list, int, (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_7,(in, out, (in, out), (in, ))).
direction(ho_60,(in, in, (in, out))).
direction(ho_94,(in, out, (in, ), (in, ))).
direction(ho_155,(in, (in, ))).
direction(ho_188,(in, (in, in))).
direction(ho_320,(in, out, (in, ), (in, ))).
