...
body_pred(ho_7,2,ho).
body_pred(ho_74,4,ho).
body_pred(ho_1,3,ho).
body_pred(ho_29,2,ho).
body_pred(ho_167,3,ho).
body_pred(ho_267,2,ho).
body_pred(ho_185,4,ho).
body_pred(ho_118,4,ho).
type(ho_1,(list, list, (list, list))).
type(ho_7,(list, (element, ))).
type(ho_29,(list, (element, ))).
type(ho_45,(element, list, list, (list, list))).
type(ho_74,(list, list, (list, list), (element, ))).
type(ho_118,(list, int, (element, ), (element, ))).
type(ho_167,(list, list, (element, element))).
type(ho_185,(list, list, (element, ), (element, ))).
type(ho_244,(element, list, list, (list, list))).
type(ho_267,(list, (element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_7,(in, (in, ))).
direction(ho_29,(in, (in, ))).
direction(ho_45,(in, in, out, (in, out))).
direction(ho_74,(in, out, (in, out), (in, ))).
direction(ho_118,(in, out, (in, ), (in, ))).
direction(ho_167,(in, in, (in, out))).
direction(ho_185,(in, out, (in, ), (in, ))).
