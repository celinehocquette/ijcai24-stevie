...
body_pred(ho_27,2,ho).
body_pred(ho_188,4,ho).
body_pred(ho_39,4,ho).
body_pred(ho_163,3,ho).
body_pred(ho_116,4,ho).
body_pred(ho_1,2,ho).
body_pred(ho_71,4,ho).
type(ho_1,(list, (element, ))).
type(ho_27,(list, (element, ))).
type(ho_39,(element, list, list, (list, list))).
type(ho_71,(list, list, (list, list), (element, ))).
type(ho_116,(list, int, (element, ), (element, ))).
type(ho_163,(list, list, (element, element))).
type(ho_188,(list, list, (element, ), (element, ))).
direction(ho_1,(in, (in, ))).
direction(ho_27,(in, (in, ))).
direction(ho_39,(in, in, out, (in, out))).
direction(ho_71,(in, out, (in, out), (in, ))).
direction(ho_116,(in, out, (in, ), (in, ))).
direction(ho_163,(in, in, (in, out))).
direction(ho_188,(in, out, (in, ), (in, ))).
