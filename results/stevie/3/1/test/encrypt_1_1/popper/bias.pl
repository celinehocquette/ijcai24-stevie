...
body_pred(ho_25,2,ho).
body_pred(ho_113,4,ho).
body_pred(ho_183,4,ho).
body_pred(ho_70,4,ho).
body_pred(ho_164,3,ho).
body_pred(ho_3,2,ho).
type(ho_3,(list, (element, ))).
type(ho_25,(list, (element, ))).
type(ho_70,(list, list, (list, list), (element, ))).
type(ho_113,(list, int, (element, ), (element, ))).
type(ho_164,(list, list, (element, element))).
type(ho_183,(list, list, (element, ), (element, ))).
direction(ho_3,(in, (in, ))).
direction(ho_25,(in, (in, ))).
direction(ho_70,(in, out, (in, out), (in, ))).
direction(ho_113,(in, out, (in, ), (in, ))).
direction(ho_164,(in, in, (in, out))).
direction(ho_183,(in, out, (in, ), (in, ))).
