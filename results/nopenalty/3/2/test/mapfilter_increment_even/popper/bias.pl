...
body_pred(ho_57,4,ho).
body_pred(ho_15,4,ho).
body_pred(ho_26,4,ho).
body_pred(ho_305,3,ho).
body_pred(ho_1,3,ho).
body_pred(ho_152,5,ho).
body_pred(ho_8,5,ho).
body_pred(ho_490,4,ho).
body_pred(ho_187,5,ho).
type(ho_1,(list, list, (list, list))).
type(ho_8,(list, list, (list, list), (list, element), (element, ))).
type(ho_15,(list, (list, element), (element, ), (list, list))).
type(ho_26,(list, (list, element), (list, list), (element, ))).
type(ho_57,(list, (list, list), (list, ), (element, element))).
type(ho_152,(list, int, (list, list), (element, ), (element, ))).
type(ho_187,(list, list, (list, ), (list, list), (element, element))).
type(ho_305,(list, element, (element, element, element))).
type(ho_490,(list, list, (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_8,(in, out, (in, out), (in, out), (in, ))).
direction(ho_15,(in, (in, out), (in, ), (in, out))).
direction(ho_26,(in, (in, out), (in, out), (in, ))).
direction(ho_57,(in, (in, out), (in, ), (in, in))).
direction(ho_152,(in, out, (in, out), (in, ), (in, ))).
direction(ho_187,(in, in, (in, ), (in, out), (in, out))).
direction(ho_305,(in, out, (in, in, out))).
direction(ho_490,(in, out, (in, ), (in, ))).
