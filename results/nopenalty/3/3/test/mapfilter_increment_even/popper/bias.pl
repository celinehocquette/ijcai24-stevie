...
body_pred(ho_14,3,ho).
body_pred(ho_1,3,ho).
body_pred(ho_312,4,ho).
body_pred(ho_104,4,ho).
body_pred(ho_493,4,ho).
body_pred(ho_8,5,ho).
body_pred(ho_195,5,ho).
type(ho_1,(list, list, (list, list))).
type(ho_8,(list, list, (list, list), (list, element), (element, ))).
type(ho_14,(list, (element, ), (list, list))).
type(ho_25,(list, (list, ), (element, ))).
type(ho_44,(list, (element, element))).
type(ho_104,(list, int, (element, ), (element, ))).
type(ho_187,(list, list, (list, ), (list, list), (element, element))).
type(ho_195,(element, list, list, (list, list), (list, list))).
type(ho_312,(list, element, (element, ), (element, element, element))).
type(ho_493,(list, list, (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_8,(in, out, (in, out), (in, out), (in, ))).
direction(ho_14,(in, (in, ), (in, out))).
direction(ho_25,(in, (in, ), (in, ))).
direction(ho_44,(in, (in, in))).
direction(ho_104,(in, out, (in, ), (in, ))).
direction(ho_187,(in, in, (in, ), (in, out), (in, out))).
direction(ho_195,(in, in, out, (in, out), (in, out))).
direction(ho_312,(in, out, (out, ), (in, in, out))).
