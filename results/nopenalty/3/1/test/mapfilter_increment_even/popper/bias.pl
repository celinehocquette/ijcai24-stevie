...
body_pred(ho_147,5,ho).
body_pred(ho_29,4,ho).
body_pred(ho_324,5,ho).
body_pred(ho_1,3,ho).
body_pred(ho_55,4,ho).
body_pred(ho_9,2,ho).
body_pred(ho_186,5,ho).
body_pred(ho_8,5,ho).
type(ho_1,(list, list, (list, list))).
type(ho_8,(list, list, (list, list), (list, element), (element, ))).
type(ho_9,(list, (element, ))).
type(ho_29,(list, (list, ), (list, list), (element, ))).
type(ho_55,(list, (list, list), (list, element), (element, element))).
type(ho_147,(list, int, (element, ), (element, ), (int, int))).
type(ho_186,(list, list, (list, ), (list, list), (element, element))).
type(ho_324,(list, element, (list, ), (list, list), (element, element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_8,(in, out, (in, out), (in, out), (in, ))).
direction(ho_9,(in, (in, ))).
direction(ho_29,(in, (in, ), (in, out), (in, ))).
direction(ho_55,(in, (in, out), (in, out), (in, in))).
direction(ho_147,(in, in, (in, ), (in, ), (in, out))).
direction(ho_186,(in, in, (in, ), (in, out), (in, out))).
direction(ho_324,(in, out, (in, ), (in, out), (in, in, out))).
