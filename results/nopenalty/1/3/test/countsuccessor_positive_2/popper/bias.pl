...
body_pred(ho_203,4,ho).
body_pred(ho_608,5,ho).
body_pred(ho_493,4,ho).
body_pred(ho_152,5,ho).
body_pred(ho_405,4,ho).
body_pred(ho_73,5,ho).
body_pred(ho_139,3,ho).
body_pred(ho_35,2,ho).
body_pred(ho_135,5,ho).
body_pred(ho_1,3,ho).
body_pred(ho_303,5,ho).
body_pred(ho_22,5,ho).
type(ho_1,(list, list, (list, list))).
type(ho_22,(list, list, (list, list), (list, element), (element, ))).
type(ho_35,(list, (element, ))).
type(ho_73,(element, list, list, (list, list), (list, list))).
type(ho_135,(list, list, (list, ), (list, element), (element, element))).
type(ho_139,(list, (list, element), (element, ))).
type(ho_152,(element, list, list, (element, ), (list, list))).
type(ho_203,(list, element, (element, ), (element, element, element))).
type(ho_303,(list, int, (list, element), (element, ), (element, ))).
type(ho_405,(list, (list, list), (list, ), (element, element))).
type(ho_493,(list, list, (element, ), (element, ))).
type(ho_608,(list, element, (element, ), (list, element), (element, element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_22,(in, out, (in, out), (in, out), (in, ))).
direction(ho_35,(in, (in, ))).
direction(ho_73,(in, in, out, (in, out), (in, out))).
direction(ho_135,(in, in, (in, ), (in, out), (in, out))).
direction(ho_139,(in, (in, out), (in, ))).
direction(ho_152,(in, in, out, (in, ), (in, out))).
direction(ho_203,(in, out, (in, ), (in, in, out))).
direction(ho_303,(in, out, (in, out), (in, ), (in, ))).
direction(ho_405,(in, (in, out), (in, ), (in, in))).
direction(ho_493,(in, out, (in, ), (in, ))).
direction(ho_608,(in, out, (in, ), (in, out), (in, in, out))).



head_pred(countsuccessor_positive_2,2).
type(countsuccessor_positive_2,(list,int)).
direction(countsuccessor_positive_2,(in,out)).
