...
body_pred(ho_124,3,ho).
body_pred(ho_280,5,ho).
body_pred(ho_46,4,ho).
body_pred(ho_149,5,ho).
type(ho_19,(list, list, (list, list), (element, ))).
type(ho_46,(list, (list, ), (list, element), (element, ))).
type(ho_124,(list, list, (element, element))).
type(ho_149,(element, list, list, (element, ), (list, list))).
type(ho_280,(list, int, (element, ), (element, ), (int, int))).
direction(ho_19,(in, out, (in, out), (in, ))).
direction(ho_46,(in, (in, ), (in, out), (in, ))).
direction(ho_124,(in, in, (in, out))).
direction(ho_149,(in, in, out, (in, ), (in, out))).
direction(ho_280,(in, in, (in, ), (in, ), (in, out))).
