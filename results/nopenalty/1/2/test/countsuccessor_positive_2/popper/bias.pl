...
body_pred(ho_292,5,ho).
body_pred(ho_19,4,ho).
body_pred(ho_153,6,ho).
body_pred(ho_135,5,ho).
body_pred(ho_1,3,ho).
body_pred(ho_34,2,ho).
type(ho_1,(list, list, (list, list))).
type(ho_19,(list, list, (list, list), (element, ))).
type(ho_34,(list, (element, ))).
type(ho_135,(list, list, (list, ), (list, element), (element, element))).
type(ho_153,(element, list, list, (element, ), (element, element), (list, list))).
type(ho_292,(list, int, (element, ), (element, ), (int, int))).
direction(ho_1,(in, out, (in, out))).
direction(ho_19,(in, out, (in, out), (in, ))).
direction(ho_34,(in, (in, ))).
direction(ho_135,(in, in, (in, ), (in, out), (in, out))).
direction(ho_153,(in, in, out, (in, ), (in, out), (in, out))).
direction(ho_292,(in, in, (in, ), (in, ), (in, out))).
