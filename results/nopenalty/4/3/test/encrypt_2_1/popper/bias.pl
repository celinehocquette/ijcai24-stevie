...
body_pred(ho_181,5,ho).
body_pred(ho_121,5,ho).
body_pred(ho_1,3,ho).
body_pred(ho_5,2,ho).
body_pred(ho_59,3,ho).
body_pred(ho_242,5,ho).
body_pred(ho_53,5,ho).
body_pred(ho_160,5,ho).
body_pred(ho_171,3,ho).
body_pred(ho_431,2,ho).
type(ho_1,(list, list, (list, list))).
type(ho_5,(list, (element, ))).
type(ho_53,(list, list, (list, element), (list, list), (element, element))).
type(ho_59,(list, element, (element, element, element))).
type(ho_121,(list, list, (list, list), (list, element), (element, ))).
type(ho_160,(list, list, (list, element, list), (element, ), (element, ))).
type(ho_171,(list, (list, element), (element, ))).
type(ho_181,(element, list, list, (list, list), (list, list))).
type(ho_242,(list, int, (int, ), (element, ), (element, ))).
type(ho_431,(list, (element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_5,(in, (in, ))).
direction(ho_53,(in, in, (in, out), (in, out), (in, out))).
direction(ho_59,(in, out, (in, in, out))).
direction(ho_121,(in, out, (in, out), (in, out), (in, ))).
direction(ho_160,(in, out, (in, out, out), (in, ), (in, ))).
direction(ho_171,(in, (in, out), (in, ))).
direction(ho_181,(in, in, out, (in, out), (in, out))).
direction(ho_242,(in, out, (in, ), (in, ), (in, ))).
direction(ho_431,(in, (in, in))).
