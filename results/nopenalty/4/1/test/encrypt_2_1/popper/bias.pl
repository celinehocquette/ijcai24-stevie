...
body_pred(ho_120,4,ho).
body_pred(ho_54,5,ho).
body_pred(ho_1,3,ho).
body_pred(ho_188,6,ho).
body_pred(ho_252,5,ho).
body_pred(ho_15,4,ho).
body_pred(ho_172,4,ho).
type(ho_1,(list, list, (list, list))).
type(ho_15,(list, (list, ), (list, list), (element, ))).
type(ho_54,(list, list, (list, ), (list, list), (element, element))).
type(ho_120,(list, list, (list, list), (element, ))).
type(ho_172,(list, (list, element), (element, ), (list, list))).
type(ho_188,(element, list, list, (element, ), (element, element), (list, list))).
type(ho_252,(list, int, (int, ), (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_15,(in, (in, ), (in, out), (in, ))).
direction(ho_54,(in, in, (in, ), (in, out), (in, out))).
direction(ho_120,(in, out, (in, out), (in, ))).
direction(ho_172,(in, (in, out), (in, ), (in, out))).
direction(ho_188,(in, in, out, (in, ), (in, out), (in, out))).
direction(ho_252,(in, out, (in, ), (in, ), (in, ))).
