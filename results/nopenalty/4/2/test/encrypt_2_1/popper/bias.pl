...
body_pred(ord,2).
type(ord,(element,int)).
direction(ord,(in,out)).

body_pred(inttochar,2).
type(inttochar,(int,element)).
...
body_pred(ho_432,3,ho).
body_pred(ho_166,2,ho).
body_pred(ho_14,4,ho).
body_pred(ho_1,3,ho).
body_pred(ho_151,5,ho).
body_pred(ho_118,4,ho).
body_pred(ho_53,5,ho).
body_pred(ho_183,5,ho).
body_pred(ho_55,3,ho).
body_pred(ho_248,5,ho).
type(ho_1,(list, list, (list, list))).
type(ho_14,(list, (list, ), (list, element), (element, ))).
type(ho_53,(list, list, (list, ), (list, element), (element, element))).
type(ho_55,(list, element, (element, element, element))).
type(ho_118,(list, list, (list, list), (element, ))).
type(ho_151,(list, list, (list, ), (element, ), (element, ))).
type(ho_166,(list, (element, ))).
type(ho_183,(element, list, list, (element, ), (list, list))).
type(ho_248,(list, int, (int, ), (element, ), (element, ))).
type(ho_432,(list, (list, list), (element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_14,(in, (in, ), (in, out), (in, ))).
direction(ho_53,(in, in, (in, ), (in, out), (in, out))).
direction(ho_55,(in, out, (in, in, out))).
direction(ho_118,(in, out, (in, out), (in, ))).
direction(ho_151,(in, out, (in, ), (in, ), (in, ))).
direction(ho_166,(in, (in, ))).
direction(ho_183,(in, in, out, (in, ), (in, out))).
direction(ho_248,(in, out, (in, ), (in, ), (in, ))).
direction(ho_432,(in, (in, out), (in, in))).



head_pred(encrypt_2_1,2).
type(encrypt_2_1,(list,list)).
direction(encrypt_2_1,(in,in)).
