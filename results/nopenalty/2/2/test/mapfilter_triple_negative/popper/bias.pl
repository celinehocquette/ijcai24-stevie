...
body_pred(ho_178,5,ho).
body_pred(ho_452,4,ho).
body_pred(ho_290,5,ho).
body_pred(ho_1,3,ho).
body_pred(ho_15,5,ho).
body_pred(ho_33,4,ho).
body_pred(ho_366,5,ho).
body_pred(ho_316,3,ho).
type(ho_1,(list, list, (list, list))).
type(ho_15,(list, list, (list, list), (list, element), (element, ))).
type(ho_33,(element, list, list, (list, list))).
type(ho_178,(list, int, (list, element), (element, ), (element, ))).
type(ho_290,(list, list, (element, ), (element, ), (element, list, list))).
type(ho_316,(list, list, (element, element))).
type(ho_366,(list, element, (element, ), (list, element), (element, element, element))).
type(ho_452,(list, (list, list), (list, ), (element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_15,(in, out, (in, out), (in, out), (in, ))).
direction(ho_33,(in, in, out, (in, out))).
direction(ho_178,(in, out, (in, out), (in, ), (in, ))).
direction(ho_290,(in, in, (in, ), (in, ), (in, in, out))).
direction(ho_316,(in, in, (in, out))).
direction(ho_366,(in, out, (in, ), (in, out), (in, in, out))).
direction(ho_452,(in, (in, out), (in, ), (in, in))).
