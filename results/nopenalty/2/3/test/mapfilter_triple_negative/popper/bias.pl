...
body_pred(ho_38,5,ho).
body_pred(ho_179,5,ho).
body_pred(ho_447,3,ho).
body_pred(ho_361,4,ho).
body_pred(ho_290,5,ho).
body_pred(ho_55,4,ho).
body_pred(ho_1,3,ho).
body_pred(ho_319,3,ho).
type(ho_1,(list, list, (list, list))).
type(ho_14,(list, list, (list, list), (element, ))).
type(ho_38,(element, list, list, (list, list), (list, list))).
type(ho_55,(list, (list, element), (list, list), (element, ))).
type(ho_179,(list, int, (element, ), (element, ), (int, int))).
type(ho_290,(list, list, (list, ), (element, ), (element, ))).
type(ho_319,(list, list, (element, element))).
type(ho_361,(list, element, (element, ), (element, element, element))).
type(ho_447,(list, (list, list), (element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_14,(in, out, (in, out), (in, ))).
direction(ho_38,(in, in, out, (in, out), (in, out))).
direction(ho_55,(in, (in, out), (in, out), (in, ))).
direction(ho_179,(in, in, (in, ), (in, ), (in, out))).
direction(ho_290,(in, out, (in, ), (in, ), (in, ))).
direction(ho_319,(in, in, (in, out))).
direction(ho_361,(in, out, (out, ), (in, in, out))).
direction(ho_447,(in, (in, out), (in, in))).



head_pred(mapfilter_triple_negative,2).
type(mapfilter_triple_negative,(list,list)).
direction(mapfilter_triple_negative,(in,in)).
