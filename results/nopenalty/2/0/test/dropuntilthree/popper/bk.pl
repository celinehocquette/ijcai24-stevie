...
ho_210(A,B,P,Q,R)  :- head(A,C),tail(A,D),call(P,C),ho_210(D,B,P,Q,R).

ho_210(A,B,P,Q,R)  :- head(A,C),tail(A,D),call(Q,C),ho_210(D,E,P,Q,R),call(R,E,B).

ho_14(A,B,P,Q,R)  :- call(P,A,B),call(Q,B,C),call(R,C).

ho_14(A,B,P,Q,R)  :- call(P,A,C),ho_14(C,B,P,Q,R).
...
ho_275(A,B,P,Q)  :- cons3(A,C,D),call(P,C),ho_275(D,B,P,Q).

ho_275(A,B,P,Q)  :- cons3(A,C,D),ho_275(D,E,P,Q),call(Q,C),cons(C,E,B).
