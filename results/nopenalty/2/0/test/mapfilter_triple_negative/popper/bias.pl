...
body_pred(ho_210,5,ho).
body_pred(ho_275,4,ho).
body_pred(ho_42,6,ho).
body_pred(ho_14,5,ho).
type(ho_14,(list, list, (list, list), (list, element), (element, ))).
type(ho_42,(element, list, list, (element, ), (list, list), (list, list))).
type(ho_210,(list, int, (element, ), (element, ), (int, int))).
type(ho_275,(list, list, (element, ), (element, ))).
direction(ho_14,(in, out, (in, out), (in, out), (in, ))).
direction(ho_42,(in, in, out, (in, ), (in, out), (in, out))).
direction(ho_210,(in, in, (in, ), (in, ), (in, out))).
direction(ho_275,(in, out, (in, ), (in, ))).
