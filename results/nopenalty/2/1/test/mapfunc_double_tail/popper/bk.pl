...
ho_368(A,B,P,Q,R)  :- call(P,A),call(Q,B).

ho_368(A,B,P,Q,R)  :- head(A,C),tail(A,D),ho_368(D,E,P,Q,R),call(R,C,E,B).

ho_288(A,B,P,Q,R)  :- empty(A),empty(B).

ho_288(A,B,P,Q,R)  :- cons3(A,C,D),call(P,C),ho_288(D,B,P,Q,R).

ho_288(A,B,P,Q,R)  :- cons3(A,C,D),ho_288(D,E,P,Q,R),call(Q,C),call(R,C,E,B).

ho_328(A,B,P,Q,R)  :- call(P,A),call(P,B).

ho_328(A,B,P,Q,R)  :- head(A,C),call(Q,A,D),head(B,E),call(Q,B,F),call(R,C,E),ho_328(D,F,P,Q,R).

ho_211(A,B,P,Q,R)  :- empty(A),call(P,B).

ho_211(A,B,P,Q,R)  :- head(A,C),tail(A,D),call(Q,C),ho_211(D,B,P,Q,R).

ho_211(A,B,P,Q,R)  :- head(A,C),tail(A,D),call(R,C),ho_211(D,E,P,Q,R),my_increment(E,B).

ho_13(A,B,P,Q)  :- call(P,A,B),head(B,C),call(Q,C).

ho_13(A,B,P,Q)  :- call(P,A,C),ho_13(C,B,P,Q).

ho_41(A,B,C,P,Q,R)  :- call(P,A),call(Q,B,C).

ho_41(A,B,C,P,Q,R)  :- decrement(A,D),ho_41(D,B,E,P,Q,R),call(R,E,C).
