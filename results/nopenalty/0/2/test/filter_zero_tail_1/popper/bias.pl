...
body_pred(ho_161,3,ho).
body_pred(ho_445,4,ho).
body_pred(ho_115,5,ho).
body_pred(ho_232,4,ho).
body_pred(ho_177,5,ho).
body_pred(ho_239,5,ho).
body_pred(ho_24,5,ho).
body_pred(ho_142,5,ho).
body_pred(ho_1,3,ho).
body_pred(ho_358,5,ho).
type(ho_1,(list, list, (list, list))).
type(ho_24,(list, element, (element, ), (list, list), (element, element, element))).
type(ho_115,(list, int, (int, ), (element, ), (element, ))).
type(ho_142,(list, list, (list, element), (list, list), (element, element))).
type(ho_161,(list, (list, element), (element, ))).
type(ho_177,(element, list, list, (list, list), (list, list))).
type(ho_232,(list, (list, element), (list, list), (element, ))).
type(ho_239,(list, list, (list, list), (list, element), (element, ))).
type(ho_358,(list, list, (list, element, list), (element, ), (element, ))).
type(ho_445,(list, (list, list), (list, element), (element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_24,(in, out, (in, ), (in, out), (in, in, out))).
direction(ho_115,(in, out, (in, ), (in, ), (in, ))).
direction(ho_142,(in, in, (in, out), (in, out), (in, out))).
direction(ho_161,(in, (in, out), (in, ))).
direction(ho_177,(in, in, out, (in, out), (in, out))).
direction(ho_232,(in, (in, out), (in, out), (in, ))).
direction(ho_239,(in, out, (in, out), (in, out), (in, ))).
direction(ho_358,(in, out, (in, out, out), (in, ), (in, ))).
