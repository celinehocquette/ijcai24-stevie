...
body_pred(ho_220,2,ho).
body_pred(ho_355,5,ho).
body_pred(ho_438,3,ho).
body_pred(ho_171,4,ho).
body_pred(ho_18,5,ho).
body_pred(ho_239,5,ho).
body_pred(ho_163,4,ho).
body_pred(ho_142,5,ho).
body_pred(ho_113,5,ho).
body_pred(ho_1,3,ho).
body_pred(ho_251,6,ho).
type(ho_1,(list, list, (list, list))).
type(ho_18,(list, element, (list, ), (element, ), (element, element, element))).
type(ho_113,(list, int, (element, ), (element, ), (int, int))).
type(ho_142,(list, list, (list, ), (list, element), (element, element))).
type(ho_163,(list, (list, element), (element, ), (list, list))).
type(ho_171,(element, list, list, (list, list))).
type(ho_220,(list, (element, ))).
type(ho_239,(list, list, (list, list), (list, element), (element, ))).
type(ho_251,(element, list, list, (list, list), (element, element), (list, list))).
type(ho_355,(list, list, (list, ), (element, ), (element, ))).
type(ho_438,(list, (list, list), (element, element))).
direction(ho_1,(in, out, (in, out))).
direction(ho_18,(in, out, (in, ), (in, ), (in, in, out))).
direction(ho_113,(in, in, (in, ), (in, ), (in, out))).
direction(ho_142,(in, in, (in, ), (in, out), (in, out))).
direction(ho_163,(in, (in, out), (in, ), (in, out))).
direction(ho_171,(in, in, out, (in, out))).
direction(ho_220,(in, (in, ))).
direction(ho_239,(in, out, (in, out), (in, out), (in, ))).
direction(ho_251,(in, in, out, (in, out), (in, out), (in, out))).
direction(ho_355,(in, out, (in, ), (in, ), (in, ))).
direction(ho_438,(in, (in, out), (in, in))).



head_pred(filter_zero_tail_1,2).
type(filter_zero_tail_1,(list,list)).
direction(filter_zero_tail_1,(in,out)).
