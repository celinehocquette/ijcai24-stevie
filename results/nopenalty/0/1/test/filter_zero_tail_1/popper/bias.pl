...
body_pred(ho_173,4,ho).
body_pred(ho_346,4,ho).
body_pred(ho_157,2,ho).
body_pred(ho_142,5,ho).
body_pred(ho_1,3,ho).
body_pred(ho_103,5,ho).
type(ho_1,(list, list, (list, list))).
type(ho_103,(list, int, (list, ), (element, ), (element, ))).
type(ho_142,(list, list, (list, element), (list, list), (element, element))).
type(ho_157,(list, (element, ))).
type(ho_173,(element, list, list, (list, list))).
type(ho_346,(list, list, (element, ), (element, ))).
direction(ho_1,(in, out, (in, out))).
direction(ho_103,(in, out, (in, ), (in, ), (in, ))).
direction(ho_142,(in, in, (in, out), (in, out), (in, out))).
direction(ho_157,(in, (in, ))).
direction(ho_173,(in, in, out, (in, out))).
direction(ho_346,(in, out, (in, ), (in, ))).
