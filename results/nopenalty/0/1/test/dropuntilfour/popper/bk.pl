...
ho_157(A,P)  :- head(A,B),call(P,B).

ho_157(A,P)  :- tail(A,B),ho_157(B,P).

ho_173(A,B,C,P)  :- zero_in(A),eq_list(B,C).

ho_173(A,B,C,P)  :- decrement(A,D),call(P,B,E),ho_173(D,E,C,P).
...
ho_346(A,B,P,Q)  :- cons3(A,C,D),call(P,C),ho_346(D,B,P,Q).

ho_346(A,B,P,Q)  :- cons3(A,C,D),ho_346(D,E,P,Q),call(Q,C),cons(C,E,B).

ho_103(A,B,P,Q,R)  :- call(P,A),zero_int(B).

ho_103(A,B,P,Q,R)  :- head(A,C),tail(A,D),call(Q,C),ho_103(D,B,P,Q,R).

ho_103(A,B,P,Q,R)  :- head(A,C),tail(A,D),call(R,C),ho_103(D,E,P,Q,R),my_increment(E,B).
